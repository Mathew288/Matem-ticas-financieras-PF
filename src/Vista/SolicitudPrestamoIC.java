...
public class SolicitudPrestamoIC extends javax.swing.JFrame {

    public SolicitudPrestamoIC() {
        initComponents();
        ...
        setTitle("Solicitud de préstamo con interés compuesto.");
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Solicitud de préstamo con interés compuesto.");
    ...
    private void botonCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCalcularActionPerformed
        ...
        double montoTotal = Funcionalidades.interesCompuesto(capital, tiempo, interes);
        double interesAPagar = montoTotal - capital;
        double valor = montoTotal / (tiempo * 12);

        DecimalFormat dosDecimales = new DecimalFormat("#.00");

        TablaAmortizacionIC objTabla = new TablaAmortizacionIC();
        objTabla.setTiempo(tiempo * 12);
        objTabla.setValor(valor);

        objTabla.getLabelMontoTotal().setText(dosDecimales.format(montoTotal));
        objTabla.getLabelInteresAPagar().setText(dosDecimales.format(interesAPagar));
        objTabla.getLabelCapitalIngresado().setText(dosDecimales.format(capital));
        objTabla.getLabelTiempo().setText("" + Math.round(tiempo));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SolicitudPrestamoIC().setVisible(true);
            }
        });
    }
