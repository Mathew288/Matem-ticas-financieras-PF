...
public class SolicitudPrestamoIS extends javax.swing.JFrame {

    public SolicitudPrestamoIS() {
        initComponents();
        ...
        setTitle("Solicitud de préstamo con interés simple.");
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Solicitud de préstamo con interés simple.");
    ...
    private void botonCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCalcularActionPerformed
        ...
        TablaAmortizacionIS objTabla = new TablaAmortizacionIS();
    ...
    private void itemSolicitudInteresCompuestoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemSolicitudInteresCompuestoActionPerformed
        // TODO add your handling code here:
        this.setVisible(false);
        SolicitudPrestamoIS ventana = new SolicitudPrestamoIS();
        ventana.setVisible(true);
