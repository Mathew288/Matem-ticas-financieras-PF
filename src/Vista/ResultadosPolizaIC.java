...
public class ResultadosPolizaIC extends javax.swing.JFrame {

    public ResultadosPolizaIC() {
        initComponents();
        ...
        setTitle("Resultados: Póliza interés compuesto.");
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Poliza con interés compuesto - Resultados");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResultadosPolizaIC().setVisible(true);
            }
        });
    }
