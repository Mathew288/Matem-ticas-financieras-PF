...
public class TablaAmortizacionIS extends javax.swing.JFrame {

    int tiempo = 0;
    double valor = 0;

    public TablaAmortizacionIS() {
        initComponents();
        ...
        setTitle("Tabla de amortización interés simple");
    }
    ...
    private void initComponents() {
        ...
        botonCalcularDeNuevo = new javax.swing.JButton();
        ...
        jLabel3.setText("Tabla de amortización con interés simple");
        ...
        botonCalcularDeNuevo.setText("Calcular de nuevo");
        botonCalcularDeNuevo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonCalcularDeNuevoActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        .addGap(81, 81, 81)
                        .addComponent(botonCalcularDeNuevo)))
    ...
    private void itemSolicitudInteresCompuestoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_itemSolicitudInteresCompuestoActionPerformed
        // TODO add your handling code here:
        this.setVisible(false);
        TablaAmortizacionIS ventana = new TablaAmortizacionIS();
        ventana.setVisible(true);
    ...
    private void botonCalcularDeNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCalcularDeNuevoActionPerformed
        // TODO add your handling code here:
        this.setVisible(false);
        SolicitudPrestamoIS s = new SolicitudPrestamoIS();
        s.setVisible(true);
    }//GEN-LAST:event_botonCalcularDeNuevoActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaAmortizacionIS().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton botonCalcularDeNuevo;
